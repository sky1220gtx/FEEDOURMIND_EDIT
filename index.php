...
?>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
        ...
        <div class="w3-row-padding w3-padding-16 w3-center" id="work">
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Sandwich" style="width:100%">
                <h3>The Perfect Sandwich, A Real NYC Classic</h3>
                <p>Just some random text, lorem ipsum text praesent tincidunt ipsum lipsum.</p>
                <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-arrow-circle-right"></i> Read more</button></p>
            </div>
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Steak" style="width:100%">
                <h3>Let Me Tell You About This Steak</h3>
                <p>Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>
                <p><button class="w3-button w3-light-grey w3-block"><i class="fa fa-arrow-circle-right"></i> Read more</button></p>
            </div>
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Cherries" style="width:100%">
            ...
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Pasta and Wine" style="width:100%">
        ...
        <div class="w3-row-padding w3-padding-16 w3-center">
            ...
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Salmon" style="width:100%">
            ...
            <div class="w3-quarter">
                <img src="pic45.jpg" alt="Croissant" style="width:100%">
                <h3>Le French</h3>
    ...
    <div class="w3-container" style="padding:128px 16px" id="team">
        ...
        <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-card">
                    <img src="pic46.jpg" alt="Jane" style="width:100%">
                    <div class="w3-container">
                        <h3>Anja Doe</h3>
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-card">
                    <img src="pic46.jpg" alt="Mike" style="width:100%">
                    <div class="w3-container">
                        <h3>Mike Ross</h3>
            ...
            <div class="w3-col l3 m6 w3-margin-bottom">
                <div class="w3-card">
                    <img src="pic5.jpg" alt="Dan" style="width:100%">
                    <div class="w3-container">
                        <h3>Dan Star</h3>
